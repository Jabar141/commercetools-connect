...
//import CustomObjectUI from './components/custom-object-UI';
import HondaUI from './components/honda';
...
const ApplicationRoutes = (_props: ApplicationRoutesProps) => {
  ...
  return (
    <Spacings.Inset scale="l">
      <Switch>
        <Route path={`${match.path}/customObject`}>
          {/* <Channels linkToWelcome={match.url} /> */}
          {/* <CustomObjectUI linkToWelcome={match.url} /> */}
          <HondaUI></HondaUI>
        </Route>
        <Route>
          <Welcome />
